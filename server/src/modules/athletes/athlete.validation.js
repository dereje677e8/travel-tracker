...
const athleteBaseSchema = z.object({
  ...
  placeOfBirthProvince: z.string().max(100).optional().nullable(),
  ...
  passportIssueDate: z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'Expected YYYY-MM-DD').optional().nullable(),
  passportIssuePlace: z.string().max(150).optional().nullable(),
