...
import {
  ...
  updateRequirementHandler, destinationsHandler, uploadPhotoHandler, getPhotoHandler,
...
router.post('/:id/photo', uploadPhoto, uploadPhotoHandler);
router.get('/:id/photo', getPhotoHandler);
